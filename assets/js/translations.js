...
window.translations = {
    ...
    'kontakt_email_address': {
        'pl': 'biuro@partner-mm.pl',
        'ua': 'biuro@partner-mm.pl',
        'en': 'biuro@partner-mm.pl'
    },
    ...
    'kontakt_address_street': {
        'pl': 'ul. Bronisława Czecha 19A/lok 11',
        'ua': 'вул. Броніслава Чеха 19A/11',
        'en': 'Bronisława Czecha St. 19A/11'
    },
    'kontakt_address_city': {
        'pl': '42-224 Częstochowa',
        'ua': '42-224 Ченстохова',
        'en': '42-224 Częstochowa'
    },
    'kontakt_form_title': {
    ...
    'firmy_benefit1_desc': {
        ...
        'ua': 'Відсутність витрат на рекрутинг, початкове навчання та кадрове-платіжне обслуговування. Гнучке працевлаштування тільки тоді, коли вам дійсно потрібні працівники.',
        'en': 'No recruitment costs, initial training costs and HR-payroll service costs. Flexible employment only when you actually need employees.'
    },
    ...
    'firmy_benefit2_desc': {
        ...
        'ua': 'Ми надаємо кваліфікованих працівників протягом 24-48 годин. Швидка реакція на раптові кадрові потреби, піки виробництва чи сезонні потреби.',
        'en': 'We provide qualified employees within 24-48 hours. Fast response to sudden staffing needs, production peaks or seasonal demand.'
    },
    ...
    'firmy_benefit3_desc': {
        ...
        'ua': 'Працівники працевлаштовані через нашу агенцію. Ми беремо на себе всі формальні та юридичні обов\'язки, пов\'язані з працевлаштуванням.',
        'en': 'Employees are employed by our agency. We take over all formal and legal duties related to employment.'
    },
    ...
    'firmy_benefit4_desc': {
        ...
        'ua': 'Ми ретельно перевіряємо кваліфікацію, досвід та рекомендації кожного кандидата. Ми надаємо тільки перевірених та належним чином підготовлених працівників.',
        'en': 'We carefully check the qualifications, experience and references of each candidate. We provide only verified and properly prepared employees.'
    },
    ...
    'firmy_process3_desc': {
        ...
        'ua': 'Ми займаємось усіма формальностями, пов\'язаними з працевлаштуванням',
    ...
    'firmy_process4_desc': {
        ...
        'en': 'We provide ongoing support and monitoring of work quality'
    },
    ...
    'firmy_industry6_desc': {
        ...
        'ua': 'Прибиральники, охорона, техніки обслуговування, технічні працівники',
        'en': 'Cleaning staff, security, maintenance personnel, technical workers'
    },
    'firmy_faq_title': {
    ...
    'firmy_faq1_a': {
        ...
        'ua': 'Вартість найму тимчасового працівника розраховується індивідуально і залежить від багатьох факторів, таких як: посада, необхідна кваліфікація, термін працевлаштування, кількість працівників. Наша ставка включає заробітну плату працівника та маржу агентства за адміністративне, кадрове та платіжне обслуговування.',
    ...
    'firmy_faq3_q': {
        ...
        'ua': 'Чи можу я прийняти тимчасового працівника на постійну роботу?',
    ...
    'firmy_faq4_q': {
        ...
        'en': 'What does the process of signing a service contract look like?'
    },
    'firmy_faq4_a': {
        ...
        'en': 'After determining the details of cooperation, we prepare a service agreement. We specify in it the scope of work, number of employees, employment period, rates and other important conditions. The contract can be signed electronically or in traditional form.'
    },
    'firmy_faq5_q': {
    ...
    'pracownicy_usługi_3': {
        'pl': 'Konserwatorzy',
        'ua': 'Техніки обслуговування',
        'en': 'Maintenance personnel'
    },
    'pracownicy_usługi_4': {
        'pl': 'Pracownicy techniczni',
        'ua': 'Технічні працівники',
        'en': 'Technical workers'
    },
    ...
    'pracownicy_benefit4_desc': {
        ...
        'ua': 'Навчання, можливість отримання досвіду та перспектива постійного працевлаштування.',
        'en': 'Training, opportunity to gain experience and perspective of permanent employment.'
    },
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Apply translations
    applyPageTranslations(savedLanguage);
});